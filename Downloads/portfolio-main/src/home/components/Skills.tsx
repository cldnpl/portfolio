...
/**
 * One bronze bar per skill, a mark longer for every project that used it. It
 * used to be a bar filled to a self-assessed percentage — "90" next to
 * SwiftUI, a number nobody can check.
 */
